...
作為一個個人投資者，我希望可以在網站上切換不同的日期，來查看最近 5 個工作天內任何一天的選股結果，以便我可以回溯或追蹤近日的潛力標的。

**Why this priority**: 雖然依賴當日資料是最核心的，但提供 5 天的歷史紀錄能大幅幫助使用者回測和檢視前幾天的盤後結果，為必然需要的輔助功能。

**Independent Test**: 前端介面提供日期切換功能，切換後能向資料庫或靜態檔案取得對應日期的資料並正確渲染，且最多只能切換至近 5 天。

**Acceptance Scenarios**:

1. **Given** 系統已經累積了過去一週的資料，**When** 我在網站上點擊「選擇日期」的下拉選單或按鈕，**Then** 我只能看到並選擇最近 5 個工作天的選項。
2. **Given** 我選定了前一個工作天的日期，**When** 系統更新頁面資訊，**Then** 畫面上的股票清單會變更為該特定日期的篩選結果。
